...
interface SessionStore {
   ...
   *  start-over banner and disables input. */
  markExpired: (id: string) => void;
  /** Clear the expired flag when the server-side session list includes it again. */
  clearExpired: (id: string) => void;
  /** Merge durable server-side sessions into in-memory sidebar metadata. */
